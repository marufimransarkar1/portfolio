      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
        ...
        >
          ...
          <p className="text-white/60 text-lg leading-relaxed mb-6">
            I am a highly skilled Web Developer with a passion for building
            high-performance, aesthetically pleasing digital products. With
            years of experience in the React ecosystem and custom WordPress
            development, I bridge the gap between complex engineering and
            elegant design.
          </p>
          <p className="text-white/60 text-lg leading-relaxed mb-10">
            My philosophy is rooted in "Nocturnal Architecture"—designing
            interfaces that feel physical, deep, and intuitive. I don't just
            write code; I design experiences that help brands scale and users
            thrive.
          </p>
